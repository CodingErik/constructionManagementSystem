            ...
            <div className='modal-body'>
              ...
              >
                ...
                >
                  <div className='col-6'>
                    <div className='material'>
                      <p className='textElementMaterials'>Cranes</p>
                      <img
                        src={craneIcon}
                        width='60'
                        height='60'
                      ...
                      <input
                        ...
                        min={0}
                        max={
                          maxMachineAmount.crane ? maxMachineAmount.crane : 30
                        }
                      />
                      <small>Max Cranes: {maxMachineAmount.crane}</small>
                    </div>
                  </div>
                  <div className='col-6'>
                    <div className='material'>
                      <p className='textElementMaterials'>Drills</p>
                      <img
                        src={drillIcon}
                        width='60'
                        height='60'
                      ...
                      <input
                        ...
                        min={0}
                        max={
                          maxMachineAmount.drill ? maxMachineAmount.drill : 30
                        }
                      />
                      <small>Max Drills: {maxMachineAmount.drill}</small>
                    </div>
                  </div>
                  <div className='col-6'>
                    <div className='material'>
                      <p className='textElementMaterials'>Forklifts</p>
                      <img
                        src={forkliftIcon}
                        width='60'
                        height='60'
                      ...
                      <input
                        ...
                        defaultValue={0}
                        disabled={
                          maxMachineAmount.forklift === 0 ? true : false
                        }
                        min={0}
                        max={
                          maxMachineAmount.forklift
                            ? maxMachineAmount.forklift
                            : 30
                        }
                      />
                      <small>Max Forklifts: {maxMachineAmount.forklift}</small>
                    </div>
                  </div>
                  <div className='col-6'>
                    <div className='material'>
                      <p className='textElementMaterials'>Ladders</p>
                      <img
                        src={ladderIcon}
                        width='60'
                        height='60'
                      ...
                      <input
                        ...
                        max={
                          maxMachineAmount.ladder ? maxMachineAmount.ladder : 30
                        }
                        min={0}
                      />
                      <small>Max Ladders: {maxMachineAmount.ladder}</small>
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  disabled={
                    !hasAuthority ||
                    (maxMachineAmount.crane === 0 &&
                      maxMachineAmount.drill === 0 &&
                      maxMachineAmount.forklift === 0 &&
                      maxMachineAmount.ladder === 0)
                  }
                >
                  Purchase Machines
                </button>
