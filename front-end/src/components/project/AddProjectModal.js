...
function AddProjectModal({ modalId, handleNewProjectSubmit, hasAuthority }) {
    ...
    const handleSubmit = (event) => {
        ...
        const newProjectInfo = {
            ...
            laborBudget: laborBudgetRef.current.value? laborBudgetRef.current.value : 0,
            materialBudget: materialBudgetRef.current.value? materialBudgetRef.current.value: 0,
            totalBudget: totalBudgetRef.current.value? totalBudgetRef.current.value : 0,
    ...
    return (
        <div className="modal fade" id={modalId} tabIndex="-1" aria-labelledby="addProjectModal" aria-hidden="true">
