            ...
            <table className="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col" onClick={() => handleProjectColumnHeaderClick("salary", "employeeSalary", parseInt)}>Salary</th>
                        <th scope="col" onClick={() => handleProjectColumnHeaderClick("dateOfBirth", "employeeDateOfBirth", (a) => a.toUpperCase())}>Date Of Birth</th>
                        <th scope="col" onClick={() => handleProjectColumnHeaderClick("yearsOfExperience", "employeeYearsOfExperience", parseInt)}>Years Of Experience</th>
                        <th scope="col" onClick={() => handleProjectColumnHeaderClick("userSince", "employeeUserSince", parseInt)}>User Since</th>
                    </tr>
                </thead>
                <tbody>
                    {employeeList.map((employee) => (
                        <tr className="table-active" key={employee.id}>
                            ...
                            <td>{employee.project ? employee.project.name : "Unassigned"}</td>
