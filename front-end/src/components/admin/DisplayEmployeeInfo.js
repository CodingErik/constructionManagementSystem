...
function DisplayEmployeeInfo() {
    ...
    const handleBasicInformationUpdateSubmit = (event, updatedBasicInfo) => {
        ...
        <div>
            ...
            <div className="row">
                ...
                <div className="col-3">
                    ...
                    <AdminEditEmployeeInfoModal handleBasicInformationUpdateSubmit={handleBasicInformationUpdateSubmit} employeeInfo={employeeInfo} modalId="editEmployeeInformationModalByAdmin"></AdminEditEmployeeInfoModal>
                </div>
            </div>
            <div className="list-group text-black">
                ...
                <div className="list-group-item bg-transparent text-start ">
                    <div className="row">
                        ...
                        <div className="col-9">
                            {employeeInfo.yearsOfExperience}
                        </div>
                    </div>
                </div>
